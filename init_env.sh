...
DOCKERFILE_URL="https://raw.githubusercontent.com/leolabtec/buildopenwrtauto/refs/heads/main/Dockerfile"
...
while true; do
  ...
  case "$CHOICE" in
    1)
      echo "🔧 正在检查 Dockerfile ..."
      if [ ! -f "$DOCKERFILE_PATH" ]; then
        echo "📅 未找到 Dockerfile，正在从 GitHub 拉取..."
